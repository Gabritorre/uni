let courses = {
	algo_strut_dati1 : ["Fibonacci", "Classi asintotiche", "Calcolo della complessità", "Ricorrenze"],
 	algo_strut_dati2 : ["Le strutture dati", "Dizionari", "Esercizi calcolo delle complessità", "Alberi", "Esercizi alberi", "Alberi binari di ricerca", "Esercizi alberi binari di ricerca", "Alberi di ricerca particolari", "Ordinamento", "Quick sort", "Heap sort"],
	...
	prob_stat : ["Introduzione", "Probabilità elementare", "Esercizi Probabilità elementare", "Esercizi Probabilità elementare 2", "Probabilità condizionata e indipendenza", "Esercizi Probabilità condizionata", "Variabili casuali",  "Esercizi variabili casuali", "Esercizi costanti caratteristiche", "Variabili aleatorie discrete", "Esercizi quantili", "Variabili aleatorie continue", "Esercizi Discrete e continue", "Esercizi Discrete e continue 2", "Variabili congiunte", "Esercizi Variabili congiunte", "Catene di Markov"],
	prog_ogg1 : ["Introduzione", "Classi", "Incapsulamento", "Javadoc", "Ereditarietà", "Subtyping", "Interfacce", "Dispatch dei metodi", "Tipi generici", "Object e tipi nativi", "Eccezioni", "Annotazioni", "Reflection"],
	sis_operativi1 : ["Introduzione", "Esercizi introduzione", "Processi e thread", "Scheduling","Esercizi Processi thread e scheduling", "Gestione della memoria", "Memoria virtuale", "Segmentazione", "File system", "Memoria secondaria", "Caso di studio Linux"]
};
