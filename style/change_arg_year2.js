let courses = {
	algo_strut_dati1 : ["Fibonacci", "Classi asintotiche", "Calcolo della complessità", "Ricorrenze", "Esercizi ricorrenze"],
 	algo_strut_dati2 : ["Le strutture dati", "Dizionari", "Esercizi calcolo delle complessità", "Alberi", "Esercizi alberi", "Alberi binari di ricerca", "Esercizi alberi binari di ricerca", "Alberi di ricerca particolari", "Ordinamento", "Quick sort", "Heap sort", "Code di priorità", "Esercizi ordinamento", "Ordinamenti lineari", "Tabelle hash"],
	...
	basi_dati2 : ["Anomalie e Dipendenze funzionali", "Chiavi e coperture canoniche", "Esercizi dipendenze", "Decomposizione"],
	int_uomo_macchina : ["L'uomo"],
	prog_ogg2 : ["Introduzione", "Classi innestate"],
	sis_operativi2 : ["Comunicazione tra processi e thread", "Creazione di processi", "Esecuzione e terminazione"]
};
