let courses = {
	algo_strut_dati1 : ["Fibonacci", "Classi asintotiche", "Calcolo della complessità", "Ricorrenze", "Esercizi ricorrenze", "<Algoritmi e strutture dati mod.2>", "Grafi", "Grado nei grafi", "Isomorfismo", "Condizioni di connettività e ciclicità", "Minimum Spanning Tree", "Trovare un MST di un grafo", "Cammini minimi", "Dijkstra", "Bellman-ford", "Floyd-Warshall", "Esercizi cammini minimi", "Algoritmi greedy", "NP completezza"],
	...
	basi_dati2 : ["Anomalie e Dipendenze funzionali", "Chiavi e coperture canoniche", "Esercizi dipendenze", "Decomposizione", "Forme normali", "Esercizi normalizzazione", "Vincoli di integrità", "Trigger", "Funzioni e procedure", "Sicurezza", "Indici e viste materializzate", "Transazioni", "Applicazioni di SQL", "Applicazioni web", "NoSQL"],
	int_uomo_macchina : ["L'uomo", "La memoria", "Il pensiero", "Il computer", "Stili di interazione", "Gestures", "Interfaccia mobile", "Creazione interfaccia mobile", "User experience", "Modelli di interazione", "Ubiquitous computing", "Engagement", "Interfacce tangibili", "Realtà mista"],
	prog_ogg2 : ["Note generali", "Classi innestate", "programmazione pseudo funzionale", "Thread", "Covarianza e controvarianza", "Programmazione ad oggetti in C++"],
	sis_operativi2 : ["Comunicazione tra processi e thread", "Creazione di processi", "Esecuzione e terminazione", "Segnali", "Pipe", "Thread", "Sezione critica", "Thread in POSIX", "Semafori", "Problemi risolubili con semafori", "Monitor",  "Thread in Java", "Deadlock"]
};
