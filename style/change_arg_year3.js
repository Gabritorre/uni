let courses = {
	calc_e_ling_form : ["Note complete", "Automi a stati finiti deterministici", "Automi a stati finiti non deterministici", "Espressioni regolari", "Linguaggi non regolari", "Linguaggi context-free", "Automi a pila", "Linguaggi non context free", "Macchine di Turing", "Decidibilità", "Indecidibilità", "Esercizi decidibilità", "Riducibilità", "Storie di computazione accettanti", "Mapping-riducibilità", "Turing-riducibilità", "Teorema di Rice"],
	...
	reti_calc : ["Note complete", "Introduzione", "Livello fisico", "Livello di collegamento", "Gestione degli errori", "Condivisione delle risorse", "Livello di rete", "Count-to-Infinity", "Link-State routing", "Livello di trasporto", "Livello applicativo", "Sicurezza della rete", "HMAC, MD5 e cifratura a chiave simmetrica", "Cifratura a chiave pubblica", "Public key infrastructure", "DNS", "Posta elettronica", "Tecniche anti-spam", "HTTP", "UDP e TCP", "Controllo della congestione", "TLS", "IPv4"],
	ric_operativa : ["Note complete", "Spazi vettoriali", "Funzioni lineari, continuità e derivabilità", "Esercizi derivata direzionale", "Programmazione matematica", "Esercizi programmazione matematica", "Problemi convessi", "Esercizi convessità", "Programmazione lineare", "Poliedri", "Costi fissi e vincoli disgiunti"],
	sicurezza : ["Note complete", "Unix shell", "Stream editor ed espressioni regolari", "Assembly", "Analisi dei programmi", "Buffer overflow", "Stack overflow", "format strings", "Secure coding", "Identificazione", "Controllo degli accessi", "Firewall", "Attacchi web server side", "Side channels"],
};
