let courses = {
	...
	sicurezza : ["Note complete", "Unix shell", "Stream editor ed espressioni regolari", "Assembly", "Analisi dei programmi", "Buffer overflow", "Stack overflow", "format strings", "Secure coding", "Identificazione", "Controllo degli accessi", "Firewall", "Attacchi web server side", "Side channels", "Attacchi web client side", "XSS e CSRF"],
	lab_amm_sis : ["Note complete", "L’amministratore di sistema", "Hardware e raid", "La sala server", "Networking", "NAS e SAN", "Virtualizzazione", "Il cloud", "File system", "Boot e partizionamento", "Comandi Linux", "Shell", "Servizi di rete", "Autenticazione", "Posta elettronica", "File system distribuiti", "Backup", "Web, Apache e nginx", "Database server", "Server di stampa", "Firewall", "Docker"]
};
