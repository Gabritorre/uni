let courses = {
	...
	lab_amm_sis : ["Note complete", "L’amministratore di sistema", "Hardware e raid", "La sala server", "Networking", "NAS e SAN", "Virtualizzazione", "Il cloud", "File system", "Boot e partizionamento", "Comandi Linux"]
};
